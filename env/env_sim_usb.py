...
class rozum_sim:
    ...
    def __init__(self):
        ...
        self.scene_file = "/home/ali/RL_code/env/Kuka_scene.ttt"
        #
        ...
        self.init_socket_pose = self.get_position(self.socket_handle)
        print(self.init_socket_pose)
    ...
    def state_cost(self, state):
        ...
        pose = self.get_position(self.usb_handle)
        orientation = self.get_orientation(self.usb_handle)
        target = np.concatenate([pose, orientation], axis=0)
